...
public class ChatController implements Initializable {
    ...
    public void sendButtonAction() throws ParseException, InvalidArgumentException, SipException {
    ...
    public void sendMethod(KeyEvent event) throws ParseException, SipException, InvalidArgumentException {
